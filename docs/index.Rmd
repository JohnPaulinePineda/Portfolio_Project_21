...
|
| **[A]** The principal component analysis algorithm was implemented only for descriptors using the <mark style="background-color: #CCECFF">**stats**</mark> package.  
|
...
|
| **[A]** The singular value decomposition algorithm was implemented only for descriptors using the <mark style="background-color: #CCECFF">**stats**</mark> package.  
|
...
|
| **[A]** The independent component analysis algorithm was implemented only for descriptors using the <mark style="background-color: #CCECFF">**fastICA**</mark> package.  
|
...
|
| **[A]** The non-negative matrix factorization algorithm was implemented only for descriptors using the <mark style="background-color: #CCECFF">**NMF**</mark> package.  
|
...
|
| **[A]** The t-distributed stochastic neighbor embedding algorithm was implemented only for descriptors using the <mark style="background-color: #CCECFF">**Rtsne**</mark> package.  
|
...
|
| **[A]** The t-distributed stochastic neighbor embedding algorithm was implemented only for descriptors using the <mark style="background-color: #CCECFF">**umap**</mark> package.  
|
...
| **[Article]** [UMAP: Uniform Manifold Approximation and Projection for Dimension Reduction](https://www.jkobject.com/blog/umap-explanation/) by Jérémie Kalfon

...
# **1. Table of Contents**
|
| This project explores different dimensionality reduction algorithms for extracting information using various helpful packages in <mark style="background-color: #CCECFF">**R**</mark>. Methods applied in the analysis to transform and reduce high dimensional data included the **Principal Component Analysis**, **Singular Value Decomposition**, **Independent Component Analysis**, **Non-Negative Matrix Factorization**, **t-Distributed Stochastic Neighbor Embedding** and **Uniform Manifold Approximation and Projection** algorithms. The various algorithms were subjectively evaluated based on their capability to effectively capture the latent characteristics between the different resulting components.
|

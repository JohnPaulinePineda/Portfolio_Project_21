...
identifies a set of basis functions that can be used to represent the observed data set. These basis functions are chosen to be statistically independent and non-Gaussian. Once these basis functions are identified, they can be used to separate the observed data into its independent components.

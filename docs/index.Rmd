...
|
| [ICA](https://www.sciencedirect.com/science/article/abs/pii/0165168494900299) identifies a set of basis functions that can be used to represent the original data set by searching for a linear transformation that minimizes the statistical dependence between its components. The identified basis functions which are chosen to be statistically independent and non-Gaussian are used to separate original data set into a set of independent components.
|

...
|
| **[A]** The principal component analysis algorithm was implemented only for descriptors using the <span style="color: #FF0000">stats</span> package.  
|
...
|
| **[A]** The singular value decomposition algorithm was implemented only for descriptors using the <span style="color: #FF0000">stats</span> package.  
|
...
|
| **[A]** The independent component analysis algorithm was implemented only for descriptors using the <span style="color: #FF0000">fastICA</span> package.  
|
...
|
| **[A]** The non-negative matrix factorization algorithm was implemented only for descriptors using the <span style="color: #FF0000">NMF</span> package.  
|
...
|
| **[A]** The t-distributed stochastic neighbor embedding algorithm was implemented only for descriptors using the <span style="color: #FF0000">Rtsne</span> package.  
|
...
|
| **[A]** The t-distributed stochastic neighbor embedding algorithm was implemented only for descriptors using the <span style="color: #FF0000">umap</span> package.  
|
